 ...
 */
package net.uberhaxed.fftcg.datamodel.ability.effect.RestrictionEffect;
 ...
 * @author khalid
 */
public class RestrictionEffect implements Effect{
	public EffectTargetSpecial target;
}
